...
import org.wordpress.android.util.config.featureflags.remote.JetpackFeatureRemovalSelfHostedUsersFlag.Companion.JETPACK_FEATURE_REMOVAL_SELF_HOSTED_USERS_REMOTE_FIELD
...
class JetpackFeatureRemovalSelfHostedUsersFlag @Inject constructor(
    appConfig: AppConfig
) : FeatureFlag(
    appConfig,
