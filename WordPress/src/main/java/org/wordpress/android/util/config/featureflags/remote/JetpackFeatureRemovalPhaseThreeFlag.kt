...
import org.wordpress.android.util.config.featureflags.remote.JetpackFeatureRemovalPhaseThreeFlag.Companion.JETPACK_FEATURE_REMOVAL_PHASE_THREE_REMOTE_FIELD
import javax.inject.Inject

@RemoteFeatureFlagDefault(JETPACK_FEATURE_REMOVAL_PHASE_THREE_REMOTE_FIELD, false)
class JetpackFeatureRemovalPhaseThreeFlag @Inject constructor(
    appConfig: AppConfig
) : FeatureFlag(
    appConfig,
