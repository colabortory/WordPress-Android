...
import org.wordpress.android.util.config.featureflags.remote.JetpackBloggingRemindersSyncFeatureFlag.Companion.JETPACK_BLOGGING_REMINDERS_SYNC_REMOTE_FIELD
import javax.inject.Inject

@RemoteFeatureFlagDefault(JETPACK_BLOGGING_REMINDERS_SYNC_REMOTE_FIELD, false)
class JetpackBloggingRemindersSyncFeatureFlag
@Inject constructor(
    appConfig: AppConfig
) : FeatureFlag(
    appConfig,
