...
import org.wordpress.android.util.config.featureflags.remote.ReaderCommentsModerationFeatureFlag.Companion.READER_COMMENTS_MODERATION_REMOTE_FIELD
...
class ReaderCommentsModerationFeatureFlag
@Inject constructor(
    appConfig: AppConfig
) : FeatureFlag(
    appConfig,
