...
import org.wordpress.android.util.config.featureflags.remote.JetpackFeatureRemovalNewUsersFlag.Companion.JETPACK_FEATURE_REMOVAL_NEW_USERS_REMOTE_FIELD
...
class JetpackFeatureRemovalNewUsersFlag @Inject constructor(
    appConfig: AppConfig
) : FeatureFlag(
    appConfig,
