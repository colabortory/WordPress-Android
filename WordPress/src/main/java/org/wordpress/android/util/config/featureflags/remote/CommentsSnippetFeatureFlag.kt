...
import org.wordpress.android.util.config.featureflags.remote.CommentsSnippetFeatureFlag.Companion.COMMENTS_SNIPPET_COMMENTS_REMOTE_FIELD
...
class CommentsSnippetFeatureFlag
@Inject constructor(
    appConfig: AppConfig
) : FeatureFlag(
    appConfig,
