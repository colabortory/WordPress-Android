...
class ManualFeatureFlagTest {
    ...
    private lateinit var localFeatureConfig: FeatureFlag
    private lateinit var remoteFeatureConfig: FeatureFlag
    ...
    fun setUp() {
        ...
        localFeatureConfig = LocalFeatureFlag(appConfig)
        remoteFeatureConfig = object : FeatureFlag(appConfig, true, remoteField) {}
...
class LocalFeatureFlag(appConfig: AppConfig) : FeatureFlag(appConfig, true, null)
